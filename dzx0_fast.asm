...
ShorterOffsets:
        ld      b, #0xff                  ; the top byte of the offset is always $FF
        ld      c, (hl)
        inc     hl
        rr      c
        ld      (PrevOffset+1), bc
...
LongerRepMatch:
_LongerRepMatch_loop:
        add     a, a                    ; inline read gamma
        rl      c
        add     a, a
        jr      nc, _LongerRepMatch_loop
